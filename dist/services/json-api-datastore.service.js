...
var JsonApiDatastore = /** @class */ (function () {
    ...
    JsonApiDatastore.prototype.saveRecord = function (attributesMetadata, model, params, headers, customUrl) {
        ...
        return httpCall
            ...
            .map(function (res) { return res ? _this.resetMetadataAttributes(res, attributesMetadata, modelType) : res; })
            .map(function (res) { return res ? _this.updateRelationships(res, relationships) : res; })
            .catch(function (res) { return _this.handleError(res); });
    };
